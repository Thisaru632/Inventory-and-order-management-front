      ...
      <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <Package className="text-blue-600" /> Inventory List
          </h1>
          <p className="text-gray-500 text-sm mt-1">
            {assignedWarehouse ? `Managing stock for ${assignedWarehouse}` : 'Manage stock and materials across all locations'}
          </p>
        </div>
      ...
      <div className="flex border-b border-gray-200 gap-4">
        ...
        >
          ...
          <span className={`text-xs px-2 py-0.5 rounded-full ${
            activeTab === 'INVENTORY' ? 'bg-blue-100 text-blue-800 font-bold' : 'bg-gray-100 text-gray-600'
          }`}>
            {inventory.length}
          </span>
        </button>
        ...
        >
          ...
          Material List
          <span className={`text-xs px-2 py-0.5 rounded-full ${
            activeTab === 'MATERIALS' ? 'bg-blue-100 text-blue-800 font-bold' : 'bg-gray-100 text-gray-600'
          }`}>
            {materials.length}
          </span>
        </button>
          ...
          <div className="p-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-gray-50/50">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Edit material names, update out of stock limits, and delete records</p>
              </div>
            </div>
            <div className="relative w-full sm:w-72">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-1.5 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
              />
            </div>
          </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredMaterials.length === 0 ? (
                  ...
                  filteredMaterials.map((mat) => (
                    <tr key={mat._id} className="hover:bg-blue-50/20 transition">
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-200 transition shadow-sm"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-100 animate-in fade-in zoom-in-95 duration-150">
            <div className="flex justify-between items-center px-5 py-4 border-b border-gray-100 bg-gray-50/50">
              <div>
                <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                  <Edit2 size={18} className="text-blue-600" /> Edit Material
                </h2>
            ...
            <form onSubmit={handleSaveMaterialEdit} className="p-5 space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5">
                  Out of Stock Limit ({editingMaterial.baseUnit || 'Units'}) <span className="text-red-500">*</span>
                </label>
              ...
              <div className="pt-2 flex justify-end gap-2 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  disabled={materialActionLoading}
                  className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow transition flex items-center gap-1.5 disabled:opacity-50"
                >
